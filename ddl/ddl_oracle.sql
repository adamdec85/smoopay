    ...
    drop table BankAccountData cascade constraints;

    drop table BankAddress cascade constraints;

    drop table BankFinancialBalance cascade constraints;

    drop table BankRegistry cascade constraints;

    drop table Client cascade constraints;

    drop table ClientAccount cascade constraints;

    drop table ClientAccountData cascade constraints;

    drop table ClientAddress cascade constraints;

    drop table ClientFinancialBalance cascade constraints;

    drop table ClientPayment cascade constraints;

    drop table Merchant cascade constraints;

    drop table MerchantAccount cascade constraints;

    drop table MerchantAccountData cascade constraints;

    drop table MerchantAddress cascade constraints;

    drop table MerchantFinancialBalance cascade constraints;
