...
@Entity
public class ClientFinancialBalance extends AbstractEntity {

	private BigDecimal primaryAccountBalance;
	private BigDecimal lockedBalance;

	public ClientFinancialBalance(BigDecimal primaryAccountBalance, BigDecimal lockedBalance) {
	...
	public ClientFinancialBalance(BigDecimal primaryAccountBalance) {
		Assert.notNull(primaryAccountBalance, "PrimaryAccountBalance must not be null!");
		this.primaryAccountBalance = primaryAccountBalance;
		this.primaryAccountBalance = BigDecimal.ZERO;
	}

	protected ClientFinancialBalance() {
	}
	...
	/**
	 * Returns a copy of the current {@link ClientFinancialBalance} instance
	 * which is a new entity in terms of persistence.
	 * 
	 * @return
	 */
	public ClientFinancialBalance getCopy() {
		return new ClientFinancialBalance(this.primaryAccountBalance, this.lockedBalance);
	}

	@Override
	public String toString() {
		return "ClientFinancialBalance [primaryAccountBalance=" + primaryAccountBalance + ", lockedBalance=" + lockedBalance + "]";
	}
}