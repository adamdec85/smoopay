 ...
 */
@Entity
@Table(indexes = { @Index(name = "merchantAccBankNameIndex", columnNames = { "bankName" }), }, appliesTo = "MerchantAccountData")
public class MerchantAccountData extends AbstractEntity {
	...
	public MerchantAccountData(String bankName, String cashAccNRB, String cashAccIBAN) {
	...
	/**
	 * Returns a copy of the current {@link MerchantAccountData} instance which
	 * is a new entity in terms of persistence.
	 * 
	 * @return
	 */
	public MerchantAccountData getCopy() {
		return new MerchantAccountData(this.bankName, this.cashAccNRB, this.cashAccIBAN);
	}
