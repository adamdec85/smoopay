...
@JsonAutoDetect
public class NewPaymentResponse_1_0 extends BaseResponse {
	...
	public NewPaymentResponse_1_0() {
		super();
	}

	public NewPaymentResponse_1_0(Long paymentId, BigDecimal amount, CurrencyEnum currency) {
		super();
	...
	public NewPaymentResponse_1_0(Long paymentId, BigDecimal amount, CurrencyEnum currency, PaymentStatusEnum paymentStatus) {
		super();
		this.paymentId = paymentId;
		this.amount = amount;
		this.currency = currency;
